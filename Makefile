...
LDFLAGS+=-L. -g
#^|
EXAMPLESOBJS=  Assembling.o Preprocessing.o Transportation.o Warehouse.o register.o queue.o main.o generat.o cpu.o transduc.o distri.o com.o linpack.o debug.o trafico.o
#>
...
#^|
Assembling.o: /cygdrive/C/eclipse/workspace/SCOM/Assembling.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
Preprocessing.o: /cygdrive/C/eclipse/workspace/SCOM/Preprocessing.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
Transportation.o: /cygdrive/C/eclipse/workspace/SCOM/Transportation.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
Warehouse.o: /cygdrive/C/eclipse/workspace/SCOM/Warehouse.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
register.o: /cygdrive/C/eclipse/workspace/SCOM/register.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
#
...
#^|
Assembling.o: /cygdrive/C/eclipse/workspace/SCOM/Assembling.cpp \
 /cygdrive/C/eclipse/workspace/SCOM/Assembling.h \
...
Preprocessing.o: /cygdrive/C/eclipse/workspace/SCOM/Preprocessing.cpp \
 /cygdrive/C/eclipse/workspace/SCOM/Preprocessing.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/model.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/port.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/modelid.h \
 ...
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/ltranadm.h
Transportation.o: \
 /cygdrive/C/eclipse/workspace/SCOM/Transportation.cpp \
 /cygdrive/C/eclipse/workspace/SCOM/Transportation.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/model.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/port.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/modelid.h \
 ...
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/ltranadm.h
Warehouse.o: /cygdrive/C/eclipse/workspace/SCOM/Warehouse.cpp \
 /cygdrive/C/eclipse/workspace/SCOM/Warehouse.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/model.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/port.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/modelid.h \
